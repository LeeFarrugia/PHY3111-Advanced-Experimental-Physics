...
\subsection{Results}
function results, residuals, gradient and delta gradient, intercept and delta intercept, E and T0 and delta of E and T0
...
\hline Gradient/Nm\(^2\) & \(\Delta\)Gradient/Nm\(^2\)  & Intercept & \(\Delta\)Intercept\\ \hline
\endfirsthead
...
\begin{longtable}{|c|c|c|c|}
\hline E &\(\Delta\)E & \(\text{T}_0\) & \(\Delta\)\(\text{T}_0\)\\ \hline
\endfirsthead
...
\SI{2.79}{} & \SI{101}{} & \SI{7.98}{} & \SI{0.03}{}\\ \hline
