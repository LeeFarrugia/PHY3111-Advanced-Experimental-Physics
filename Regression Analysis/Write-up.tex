...
\subsection{Discussion}
In this task it was required to find the half life of many istopes of different elements. One of the cases was for calclium-14. This was don by first selecting the data for when Z=20 and applying a \mintinline{py}{curve_fit} on the data using the follwoing equation:
\begin{equation}
...
results_df = pd.DataFrame({'Z':z_list, 'N': n_list,
'Half Life/s': half_life_list})
